...
function Pacman(startIndex, speed) {
...
pacman = new Pacman(288, 300)
squares[pacman.currentIndex].classList.add('pacman')

function movePacman(e) {
  squares[pacman.currentIndex].classList.remove('pacman', 'pacman-left', 'pacman-up', 'pacman-down', 'pacman-right')
  switch (e.keyCode) {
    case 37:
      if (
        ...
        squares[pacman.currentIndex].classList.add('pacman-left')
      }
      if (squares[pacman.currentIndex - 1] === squares[219]) {
        pacman.currentIndex = 239
      }
      break
    case 38:
      if (
        ...
        squares[pacman.currentIndex].classList.add('pacman-up')
      }
      break
    case 39:
      if (
      ...
      if (squares[pacman.currentIndex + 1] === squares[240]) {
        pacman.currentIndex = 220
      }
      break
    case 40:
      if (
        ...
        pacman.currentIndex += width
        squares[pacman.currentIndex].classList.add('pacman-down')
      }
      break
  }
...
function checkForGameOver() {
  if (squares[pacman.currentIndex].classList.contains('ghost') &&
    !squares[pacman.currentIndex].classList.contains('scared')) {
    squares[pacman.currentIndex].classList.remove('pacman', 'pacman-left', 'pacman-up', 'pacman-down', 'pacman-right')
